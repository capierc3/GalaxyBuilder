...
public class StarSystem implements GalaxyDataBaseItem{
    ...
    public StarSystem(String sectorName, Sector.Population population, int x, int y,int secX, int secY, int secZ) {
        // sets population type
        this.population = population;
        // gets random name
        findName();
        // randomly picks how many starts are in system, single, binary, trinary, quandary
        int starCount;
        ...
        //randomly place system in respect to sector grid
        int negX = 1;
        int negY = 1;
        int negZ = 1;
    ...
    private void findName(){
        ...
        InputStream is = cl.getResourceAsStream("StarNamesSuffix.txt");
        assert is != null;
